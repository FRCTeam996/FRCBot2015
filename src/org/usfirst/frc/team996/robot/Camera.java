...
public class Camera {
	...
	//Structure to represent the scores for the various tests used for target identification
		...
		//NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(50, 100);	//Default hue range for green bin
		...
		public void CameraLoop(){
			...
			if(numParticles > 0)
			{
				...
				particles.sort(null);//This line will cause issues on non-updated FRC 2015 installs
